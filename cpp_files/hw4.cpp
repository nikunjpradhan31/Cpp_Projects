  ...
  {//switch choice
	...
	(anxiety -2 >= 0) ? (anxiety -= 2) : anxiety;
        ...
        case '4':
         if(anxiety+1<=10){
          totalbill +=20;
          cout<<"Jamie doodles on a piece a paper, but had to pay for it."<<endl;
          activity = true;
  ...
  case '2':
   ...
   switch(choice_speak){//choice_speak_switch
    case '1':
     ...
     (anxiety + 1 <= 10) ? (anxiety += 1) : anxiety;
     break;
    case '2':
     if(anxiety - 1>=0){
      anxiety -= 1;
...
}while(leave == false && operation == false);//full simulation do while
